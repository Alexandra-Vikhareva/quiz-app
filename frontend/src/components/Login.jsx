        ...
        <form onSubmit={handleSubmit} method="get" className='form'>
          <div className='container'>
            ...
            <div className='input-container'>
              ...
              <input type="email" name="email" id="email" required placeholder='name@company.com' onChange={(e) => setEmail(e.target.value)} value={email}/>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className='input-container'>
              ...
              <input  type="password" name="password" id="password" required placeholder='••••••••' onChange={(e) => setPassword(e.target.value)} value={password}/>
